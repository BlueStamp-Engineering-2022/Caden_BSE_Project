        ...
        if len(response['FaceMatches']) == 0:
            ...
            for match in response['FaceMatches']:
                ...
                if 'Item' in face:
                    ...
                    if (guest=='Caden Wei' or guest == 'Mom' or guest == 'Dad'):
                        ser=serial.Serial('/dev/ttyACM0',9600,timeout=1)
...
GPIO.add_event_detect(22,GPIO.RISING,callback=force_open)
...
def upload_image():
	...
	object = s3.Object('faceid12345','sample.jpeg')
...
def send_email(): 
    fromaddr = "cadenwei321@gmail.com"
    toaddr = "cadenwei321@gmail.com"
    ...
    filename = "sample.jpg"
    attachment = open("/home/caden/sample.jpg", "rb")
    ...
    server.starttls()
    server.login(fromaddr, "sedopqxeifnllmwr")
    text = msg.as_string()
